...
def generate_vola_url(payload) -> str:
    ...
    elif (payload["dates"].get("departureFrom") and
          payload["dates"].get("departureTo") == payload["dates"].get("departureFrom")
          and payload["dates"].get("returnFrom")
          and payload["dates"].get("returnTo") == payload["dates"].get("returnFrom")
    ):
